...
tampilan() {
    ...
    allowed_ips_url="https://raw.githubusercontent.com/pesonatunel/project/main/ip"
...
echo ""
clear
REPO="https://raw.githubusercontent.com/pesonatunel/project/main/"
start=$(date +%s)
secs_to_human() {
...
memasang_notifikasi_bot() {
  ...
  local izinsc="https://raw.githubusercontent.com/pesonatunel/project/main/ip"
  ...
  local CHATID="6678574865"
  local KEY="8377450168:AAHMn02Nt9qVVMsd9Z3_E9t4LPcVT2-Kgwc"
...
"
  ...
  local INLINE_KEYBOARD='{"inline_keyboard":[[{"text":"Telegram","url":"https://t.me/pessonacell"}]]}'
